      ...
      <Fade bottom>
        <Section id='about' className={classes.about__me}>
          ...
          <button
            onClick={() =>
              goTo(
                'https://drive.google.com/file/d/1JoJQ-atkvIdS6y9YPpY5mThXrUZADSH7/view?usp=sharing'
              )
            }
      ...
      <Section id='projects' className={classes.project__container}>
        ...
        <div className={classes.project__card__container}>
          ...
          <div className={classes.project__card}>
            ...
            <div className={classes.project__card__content}>
              ...
              <div className={classes.project__tech__info}>
                ...
                <div>
                  <button
                    onClick={() => goTo('https://timely-clone.vercel.app/')}
                    className={classNames(classes.menuButton)}
                  >
                    Live Version
                  </button>
          ...
          <div className={classes.project__card}>
            <div className={classes.img__container}>
              <img
                src={process.env.PUBLIC_URL + '/images/campaign.gif'}
                alt='timely'
              />
            </div>

            <div className={classes.project__card__content}>
              <h2>Campaign Monitor Website</h2>
              <p>
                Campaign Monitor is a email marketing and automation tools.This
                was the first collaborative project.This is a static website
                wherein we have an experience working together.This was was done
                in 3 days
              </p>
              <div className={classes.project__tech__info}>
                <h3>Technologies Used</h3>
                ...
                <div>
                  <button
                    onClick={() => goTo('https://campaign-monitor.vercel.app')}
                    className={classNames(classes.menuButton)}
                  >
                    Live Version
                  </button>
                  ...
                  <button
                    onClick={() =>
                      goTo('https://github.com/hrshrayank/Chromium')
                    }
                    className={classes.menuButton}
                  >
                    Code
                  ...
                  <button
                    onClick={() =>
                      goTo(
                        'https://hrshrayank.medium.com/campaign-manager-clone-in-just-3-days-2be2ee6b96fc'
                      )
                    }
                    className={classes.menuButton}
                  >
